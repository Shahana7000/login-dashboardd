...
const UserAuthLayout = () => {
  return (
    <div className="h-screen w-full flex overflow-y-auto lg:overflow-hidden relative bg-gray-100">
      ...
      <div className="relative z-10 w-full flex items-center justify-center p-0 lg:px-6 py-0 lg:py-10 h-screen">
        <div className="w-full max-w-[920px] h-screen lg:min-h-0 lg:h-[85vh] flex flex-col lg:flex-row  overflow-hidden shadow-2xl bg-white">
        <UserLeftPanel />
          <Outlet />
        </div>
      </div>
