...
//           <h2 className="text-[#157395] text-[28px] font-bold mb-10">Log In</h2>

//           <form onSubmit={handleSubmit} className="space-y-6">
//             {/* EMAIL */}
//             <div className="space-y-1.5">
//               <div className="flex items-center border-b border-gray-200 focus-within:border-[#157395] transition-all pb-1 gap-3">
//                 <Input
//                   type="email"
...
//                   className="bg-transparent border-none text-gray-900 text-[14px] placeholder:text-gray-400 focus-visible:ring-0 h-10 px-0 flex-1 shadow-none"
//                 />
...
//                   className="border-gray-300 data-[state=checked]:bg-[#157395] data-[state=checked]:border-[#157395] w-4 h-4 rounded-sm transition-all"
//                 />
//                 <Label htmlFor="userRememberMe" className="text-gray-500 text-[13px] font-medium cursor-pointer">
//                   Remember me
//                 </Label>
//               </div>
//               <Link to="/user-forget" className="text-[#157395] font-bold text-[13px] hover:underline transition-all">
//                 Forgot Password?
//               </Link>
//             </div>
...
//             {/* ADMIN LINK */}
//             <div className="pt-2">
//               <Link to="/" className="text-[#157395] font-bold text-[13px] hover:underline transition-colors">
//                 Admin?
//               </Link>
//             </div>
//           </form>
...
function UserLogin() {
  ...
  return (
    <>
      ...
      {/* RIGHT PANEL */}
      <div className="flex-1 flex flex-col items-center justify-center px-16 py-12 relative min-h-screen bg-[#f0f2f5] lg:w-1/2">
        <div className="w-full max-w-[360px] relative z-10">
          <h2 className="text-[#157395] text-[30px] font-bold mb-10">Log In</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-1">
              <Button
                type="submit"
                className="h-11 px-14 bg-[#1a6b8a] hover:bg-[#157395] text-white font-bold text-[14px] rounded-sm transition-all shadow-md"
              >
                Log In
              </Button>
            </div>
