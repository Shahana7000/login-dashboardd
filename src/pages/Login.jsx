          ...
          <div className="bg-[#157395] rounded-xl p-10 sm:p-12 shadow-2xl">
            ...
            <CardContent className="p-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  <div className="flex items-center border-b border-white pb-3 gap-4">
                    ...
                    <Input
                      ...
                      onChange={(e) => setEmail(e.target.value)}
                      onBlur={() => handleBlur("email")}
                      className="bg-transparent border-none text-white placeholder-white/70 focus-visible:ring-0"
                    />
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-white text-[#157395] font-bold text-lg rounded-xl shadow-lg hover:bg-gray-50 active:scale-[0.98] transition"
                >
                  SIGN IN
                </button>
